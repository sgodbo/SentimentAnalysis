...
public class AlchemyAPI {
    ...
    public String _requestUri = "http://access.alchemyapi.com/calls/";
    ...
    public void CheckHTML(String html, String url) {
    ...
    public Document GET(String callName, String callPrefix, AlchemyAPI_Params params)
    throws IOException, SAXException,
           ParserConfigurationException, XPathExpressionException
	{
    ...
    public Document doRequest(HttpURLConnection handle, String outputMode)
        throws IOException, SAXException,
               ParserConfigurationException, XPathExpressionException
    {
    ...
    public String getNodeValue(XPathFactory factory, Document doc, String xpathStr)
